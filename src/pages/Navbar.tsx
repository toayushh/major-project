    ...
    <ResizableNavbar className={cn(
      ...
      <NavBody>
        ...
        <Link to="/" className="flex items-center space-x-2">
          <span className="text-xl font-bold text-black">Leapfrog</span>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-1">
          <NavItems 
            ...
            className="flex space-x-1 [&_a]:text-black [&_a:hover]:text-gray-800"
          />
        </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem asChild>
                  <Link to="/profile" className="w-full cursor-pointer text-black">Profile</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link to="/settings" className="w-full cursor-pointer text-black">Settings</Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
